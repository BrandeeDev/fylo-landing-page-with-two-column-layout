...
const contact = ["Contact Us", "Terms", "Privacy"];
const Contact = () => {
    let i = 0;

    return (<div
        className="flex flex-col justify-start items-start  pt-[65px] pb-[42px] pl-[39px] lg:pt-[92px] lg:pl-[80px] lg:pb-[86px] lg:pr-[261px] bg-[#07043B] font-open font-normal text-white not-italic  ">
        <svg xmlns="http://www.w3.org/2000/svg" className=" w-[166px] h-[49px] ">
            <defs>
            ...
            <g fillRule="evenodd">
                ...
                <g transform="translate(72)">
                    <mask id="b" className="fill-white">
                        <use xmlns="http://www.w3.org/1999/xlink" href="#a"/>
                    </mask>
                    <path
                        ...
                        className="fill-white" mask="url(#b)"/>
                </g>
            </g>
        </svg>
        <div className="flex flex-col justify-start items-start gap-y-8 mt-8 lg:flex-row lg:justify-between lg:w-full ">
            <div className="flex flex-col justify-start items-start gap-y-4">
                <div className="flex flex-row justify-start items-center gap-x-4">
                    <img src={phone} alt="" className="w-[24px] h-[24px]"/>
                    <p className="text-base leading-6">Phone: +1-543-123-4567</p>

                </div>
                <div className="flex flex-row justify-start items-center gap-x-4">
                    <img src={email} alt="" className="w-[24px] h-[24px]"/>
                    <p className="text-base leading-6">example@fylo.com</p>
